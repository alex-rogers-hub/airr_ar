...
create_user <- function(customer_name, email, password) {
  tryCatch({
    query <- "INSERT INTO dim_customer (customer_name, join_date, email, password_hash) 
              VALUES ($1, $2, $3, $4) 
...
# workflow_example.R
source("~/AiRR/global_scripts/chatgpt_functions.R")
source("~/AiRR/global_scripts/queries_send_return.R")
source("~/AiRR/global_scripts/presence.R")
source("~/AiRR/global_scripts/perception.R")
source("~/AiRR/global_scripts/prestige.R")
